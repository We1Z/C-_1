    ...
    class Map
    {
        ...
        public void Init()
        {
            ...
            _gameMap[0,3] = new Location( "The red growing portal in the west will lead to an area with a huge flame mountain, there is a kid that is the cause of all the fire in the area. Fire is all over the mountain. Heat damage caused by fire"
                            + $" Player Stats || HP: 100 || Mana:100 || " + "\n");
            _gameMap[0,4] = new Location("Heading towards the East portal, it will get you on a boat on a dark sea area. The old man on the boat told you that by diving into a cave underneath the water will get you an ancient artifact." +
